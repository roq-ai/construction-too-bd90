...
8. As a Customer, I want to select a rental duration and outlet location for the construction tool I want to rent so that I can pick up the tool at my convenience.

9. As a Logistics Manager, I want to view and manage tool reservations so that I can ensure tools are available for customers at the right time and location.

10. As a Customer, I want to view my rental history so that I can keep track of the tools I have rented and their return dates.`;
